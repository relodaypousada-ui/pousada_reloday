  ...
  return (
    <footer className="bg-primary text-primary-foreground mt-12">
      <div className="container py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <Link to="/" className="flex items-center space-x-2 mb-4">
            ...
            <span className="font-bold text-xl">Pousada Reloday</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm opacity-80">
            ...
            <li className="flex items-center space-x-2">
              ...
              <span>contato@pousadareloday.com.br</span>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-primary-foreground/20 py-4 text-center text-xs opacity-70">
        &copy; {new Date().getFullYear()} Pousada Reloday. Todos os direitos reservados.
      </div>
    </footer>
  );
};
